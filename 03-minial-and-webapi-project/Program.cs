...
app.MapMethods("/tests", new[] { "PATCH" }, () => "toto");

app.MapGet("/from-minial-api-books", async (MyDbContext dbContext) =>
{
...
app.MapGet("/from-minial-api-books/{id}", async (int id, MyDbContext dbContext) =>
{
...
app.MapPost("/from-minial-api-books", async (Book createdBook, MyDbContext dbContext) =>
{
    ...
    return Results.Created($"/from-minial-api-books/{createdBook.Id}", createdBook);
});

app.MapDelete("/from-minial-api-books/{id}", async (int id, MyDbContext dbContext) =>
{
