...
namespace _03_minial_and_webapi_project.Controllers;

[ApiController]
[Route("from-controller-books")]
public class FromControllerBookController : ControllerBase
{
    private readonly ILogger<FromControllerBookController> _logger;
    private readonly MyDbContext _dbContext;

    public FromControllerBookController(ILogger<FromControllerBookController> logger,
